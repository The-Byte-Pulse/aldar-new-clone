    ...
    return(
        <>
         <div className="relative z-20 xl:p-10 p-8 font-open-sans hidden lg:block">
              ...
              <h4 className="mt-6 xl:text-5xl lg:text-4xl font-semibold font-poppins text-text_primary ">
                Enterprise-Grade
                <span className="text-highlight inline-block">
                  Financial Solutions
                </span>
              </h4>
              <p className="mt-6 text-text_secondary xl:w-[70%] lg:w-[80%] w-full">
                Secure, compliant, and efficient money transfer services for
