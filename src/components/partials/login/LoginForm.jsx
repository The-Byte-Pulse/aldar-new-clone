...
const LoginForm = () => {
  ...
  return (
    <div className="xl:px-8 xl:py-10 md:px-6 md:py-8 px-4 py-4 w-full">
      ...
      <form
        className="mt-6 text-sm text-text_primary font-open-sans"
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <h6 className="text-text_secondary hover:underline cursor-pointer transition duration-300">
            Forgot password?
          </h6>
        </div>
        ...
        <button
          type="submit"
          className="bg-accent text-white w-full p-2 rounded md:text-lg text-sm cursor-pointer capitalize hover:text-accent hover:bg-text_primary transition duration-500 ease-in border-2 border-accent font-poppins"
        >
          sign In
        </button>
        ...
        <div className="text-center">
          <h2>
            ...
            <NavLink
              className="ps-1 text-accent font-medium cursor-pointer hover:underline transition duration-300"
              to="/registration"
            >
